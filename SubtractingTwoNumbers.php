...
<html lang="en">
<head>
  <title> Subtracting two numbers</title>
  <meta charset="utf-8">
...
<div class="container">
  ...
  <button type="submit" class="btn btn-default" style="width:100%">Sub</button>
</form> 
...
if($flag1==1 &&  $flag2==2)
{
     ...
     $sub=$number1-$number2;
      ...
      echo "<h3 style=\"text-align:center\">Sub of two number $sub</h3>";
